...
export function EditCouponModal({
	...
	const [formData, setFormData] = useState<Coupon & {noExpiry?:string | boolean}>(coupon);
	...
	const handleImageCapture = async (
		...
		try {
			...
			if (
				data &&
				(data.code || data.discount || data.store || data.expiryDate)
			) {
				setFormData((prev) => ({
					...prev,
